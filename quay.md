...
Here my lab setup, based on the official documentation:

{% embed url="https://access.redhat.com/documentation/en-us/red\_hat\_quay/3.2/" %}
...
{% tab title="jwtproxy with preshared key" %}
```yaml
jwtproxy:
  signer_proxy:
    enabled: true
...
{% embed url="https://access.redhat.com/solutions/3516081" %}
